...
```
./mvnw clean package
docker build -t jms-practice:v1 .
```

You can then run the Docker image by executing:

```
docker run -it --rm -p 8080:8080 jms-practice:v1
```

Once the runtime starts, you can access the project at [http://localhost:8080/jms-practice](http://localhost:8080/jms-practice).
